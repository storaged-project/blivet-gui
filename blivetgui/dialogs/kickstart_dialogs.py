    ...
    def __init__(self, parent_window):
        Gtk.FileChooserDialog.__init__(self, _("Please choose a folder"), None,
            Gtk.FileChooserAction.SAVE, (Gtk.STOCK_CANCEL,
                Gtk.ResponseType.CANCEL, _("Select"), Gtk.ResponseType.OK))
...
class KickstartDuplicateMountpointDialog(Gtk.MessageDialog):
    """ Dialog window informing user about duplicate mountpoints in
        kickstart mode
    """
    ...
    def __init__(self, parent_window, mountpoint, old_device):
        ...
        Gtk.Dialog.__init__(self, _("Duplicate mountpoint detected"), None,
            Gtk.MessageType.WARNING, (Gtk.STOCK_CANCEL, Gtk.ResponseType.CANCEL,
                Gtk.STOCK_OK, Gtk.ResponseType.OK))
        ...
        info_str = _("Selected mountpoint \"{0}\" is already used for \"{1}\" " \
