...
class BlivetGUIClientTest(unittest.TestCase):
    ...
    def test_convert_answer(self):
        ...
        msg = "abcdef"
        converted_answer = BlivetGUIClient._answer_convert_to_object(MagicMock(), msg)
        ...
        test_dict = {}
        msg = ProxyID()
        converted_answer = BlivetGUIClient._answer_convert_to_object(MagicMock(id_dict=test_dict), msg)
    ...
    def test_convert_args(self):
        ...
        converted_args = client._args_convert_to_id(args)
